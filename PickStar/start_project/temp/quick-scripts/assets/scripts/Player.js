...
cc._RF.push(module, 'fe47a+umj1OIrQSXcH3eVnL', 'Player', __filename);
// scripts/Player.js
...
cc.Class({
    ...
    update: function update(dt) {
        ...
        if (this.node.x < -this.halfWinWidth) node.x += 960;else if (this.node.x > this.halfWinWidth) this.node.x -= 960;
    }
});
